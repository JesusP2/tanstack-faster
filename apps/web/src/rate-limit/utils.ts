import type { Promisify, RateLimitConfiguration, Store } from './types';

export const isValidStore = <E extends Env = Env, P extends string = string>(
  value: Store<E, P>
...
export async function getKeyAndIncrement<E extends Env, P extends string>(
