...
> = (optionsUsed: RateLimitConfiguration<E, P>) => Response;
...
> {
   ...
   */
  handler: RateLimitExceededEventHandler<E, P>;
   ...
   * successful.
   */
  requestWasSuccessful: (status: number) => Promisify<boolean>;
...
> = {
   ...
   */
  init?: (options: RateLimitConfiguration<E, P>) => void;
